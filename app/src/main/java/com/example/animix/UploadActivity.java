...
public class UploadActivity extends AppCompatActivity {
    ...
    public void saveData() {
        if (uri != null) {
            ...
            // Use a fixed name for testing (replace "test_image.jpg" with a unique name)
            ...
            storageReference.putFile(uri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                    if (task.isSuccessful()) {
                        Log.d("UploadActivity", "Image upload successful");

                        // Continue with the code to get the download URL and upload data
                        storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onFailure(@NonNull Exception exception) {
                                dialog.dismiss();
                                Log.e("UploadActivity", "Failed to get image URL", exception);
                                Toast.makeText(UploadActivity.this, "Failed to get image URL", Toast.LENGTH_SHORT).show();
                            }
                        });
                    } else {
                        dialog.dismiss();
                        Log.e("UploadActivity", "Image upload failed", task.getException());
