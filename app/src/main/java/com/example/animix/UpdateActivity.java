...
public class UpdateActivity extends AppCompatActivity {
    ...
    Button updateButton;
    EditText updateDesc, updateTopic, updateLang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null){
            ...
            updateDesc.setText(bundle.getString("Episodes"));
            updateLang.setText(bundle.getString("Genre"));
    ...
    public void saveData(){
        storageReference = FirebaseStorage.getInstance().getReference().child("AniMix Images").child(uri.getLastPathSegment());
